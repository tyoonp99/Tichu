...
- `brettspielwelt-data.md`: 원본 로그 수집·재생·검증 방법

`archive/`에는 현재 학습·평가 기준으로 사용하지 않는 v1 문서를 보관한다.

이전 rules-v1 데이터셋 문서는 v2 문서로 대체됐다. v1 관련 모델·DQN 실험 코드는
재현성 및 비교를 위해 남아 있지만 현재 모델 선택 기준으로 사용하지 않는다.
